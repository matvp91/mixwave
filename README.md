...
We intentionally keeps the scope limited. We choose to focus on a single playback protocol `HLS CMAF`, and possibly CENC / CBCS. rather than trying to support a wide range of options such as MPEG-DASH. End to end video is complex enough, it doesn't have to be. We'd rather pick a well defined stack and aim for perfection.
